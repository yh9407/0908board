...
class LoginForm extends Component {
  ...
  join = () => {
    const joinNicName = this.joinNicName.value;
    ...
    if (joinEmail === "" || joinEmail === undefined) {
      ...
      this.joinName.focus();
      return;
    } else if (joinNicName === "" || joinNicName === undefined) {
      alert("닉네임을 입력해주세요.");
      this.joinNicName.focus();
      return;
      ...
      <Form style={formStyle}>
        <Form.Group controlId="joinForm">
          ...
          <Form.Control
            ...
            placeholder="name"
          />
          <Form.Label>NicName</Form.Label>
          <Form.Control
            type="text"
            maxLength="20"
            ref={(ref) => (this.joinNicName = ref)}
            placeholder="NicName"
          />
